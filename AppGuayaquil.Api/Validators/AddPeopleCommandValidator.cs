...
public class AddPeopleCommandValidator : AbstractValidator<AddPeopleCommand>
{
    public AddPeopleCommandValidator()
    {

        RuleFor(x => x.FirstName)
            .NotEmpty().WithMessage("El campo 'FirstName' no puede estar vacío.")
            .MinimumLength(2).WithMessage("El campo 'FirstName' debe tener al menos 2 caracteres.")
